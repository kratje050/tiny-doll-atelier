const TinyStore = (() => {
  ...
  const defaultSettings = {
    ...
    chatbotShowProductImage: true,
    chatbotShowProductPrice: true,
    chatbotShowProductStock: true,
    chatbotShowProductDescription: true,
    chatbotShowProductViewButton: true,
    chatbotShowProductAddButton: true,
    chatbotSearchName: true,
    chatbotSearchCategory: true,
    chatbotSearchDescription: true,
    chatbotSearchMaterial: true,
    chatbotSearchSize: true,
    chatbotSaveHistory: true,
    chatbotShowClearButton: true,
    chatbotShowBubble: true,
    chatbotIcon: "question",
    chatbotPosition: "right",
    chatbotShowHome: true,
    chatbotShowCollection: true,
    chatbotShowProductDetail: true,
    chatbotShowCart: true,
    chatbotShowGiftCard: true,
    chatbotShowContact: true,
    chatbotShowFaq: true,
    chatbotShowAccount: true,
    chatbotShowAdmin: false,
    chatbotStats: {
      opens: 0,
      questions: 0,
      unknownQuestions: 0,
    ...
    chatbotFaqs: [
      ...
      },
      {
        id: "producten",
        title: "Producten",
        quickQuestion: "Product zoeken",
        keywords: "product, producten, collectie, zoeken, haarband, broekset, linnen, mousseline, setje, accessoire, pop 34 cm, cadeaubon",
        answer: "Vertel wat je zoekt, bijvoorbeeld haarband, broekset, linnen, mousseline, accessoire of pop 34 cm. Dan toon ik passende producten uit de collectie.",
        quickEnabled: true,
        order: 9,
      },
      {
        id: "fallback",
        title: "Fallback",
        quickQuestion: "Ik heb een andere vraag",
        keywords: "andere vraag, hulp, weet niet, vraag stellen",
        answer:
          "Dat weet ik niet zeker. Stuur ons gerust een bericht via het contactformulier of mail naar {email}. We reageren meestal binnen {reactietijd}.",
        quickEnabled: false,
        order: 10,
      },
    ],
